...
public class IndicadorServlet extends HttpServlet {
        ...
        String operacao = request.getParameter("op");
         ...
         if(codigo != null) {
            ...
            if(operacao != null && operacao.equals("deletar")){
                ...
                request.getSession().setAttribute("msg", "Indicador Exame deletado com sucesso!");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(operacao == null){
            ...
            session.setAttribute("msg", "Indicador Exame cadastrado com sucesso!");
        }
        else{
            int codigo = Integer.parseInt(request.getParameter("codigo"));
            in.setCodigo(codigo);
            RepositorioIndicadores.getCurrentInstance().alterar(in);
            session.setAttribute("msg", "Indicador Exame alterado com sucesso!");
        }
